...
class Dictionary(page.Page):
    ...
    def serve(cls, req):
        ...
        jp.Div(a=div, text="Get the definition of any "
                           "English word instantly as "
                           "you type.", classes="text-lg px-2")
        ...
        input_box = jp.Input(a=input_div, placeholder="Type a word here..",
                             classes="m-2 bg-gray-100 border-2 border-gray-200 rounded w-64 focus:bg-white"
                                     " focus:outline-none focus:border-purple-500 py-2 px-4", outputdiv=output_div)
